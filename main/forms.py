...
from .models import User, Answer, Student, Question, StudentAnswer, Subject
...
class StudentSignUpForm(UserCreationForm):
    courses = forms.ModelMultipleChoiceField(queryset=Subject.objects.all(),
...
class BaseAnswerInlineFormSet(forms.BaseInlineFormSet):
    def clean(self):
        ...
        if not has_one_correct_answer:
            raise ValidationError('Mark at least one correct answer', code='no_correct_answer')
